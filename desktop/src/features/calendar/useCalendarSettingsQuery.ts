...
import { getCalendarSettings, updateCalendarVisibility } from '@/features/calendar/api/calendar-settings-client'
import { invalidateSession, SessionExpiredError } from '@/features/auth/auth-session'
...
import { invalidateResource } from '@/app/realtime/resource-invalidation'
import type { CalendarSettingsSnapshot, ConnectedCalendar } from '@/features/calendar/types'
