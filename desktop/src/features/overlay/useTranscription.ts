...
import { getAuthenticatedAccessToken } from '@/features/auth/auth-session'
import { DeepgramClient } from '@/features/overlay/deepgram-client'
import { startMicCapture, startSystemAudioCapture, type AudioCaptureHandle } from '@/features/overlay/audio-capture'
import type { LiveTranscriptSegment } from '@/features/overlay/types'
import { saveTranscriptSegments } from '@/features/notes/api/transcript-client'
import type { TranscriptSegmentPayload } from '@/features/notes/api/transcript-client'
